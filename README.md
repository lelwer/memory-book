...
<p float="center">
  <img src="./assets/cover_preview.png" width="45%" alt="Cover Preview" style="margin-right: 10px;" />
  <img src="./assets/story_preview.png" width="45%" alt="Story Page Preview" /> 
</p>

> **Note**: (The images above show the "Armadillos" theme with "Light Blue" background)
---
